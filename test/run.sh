...
wget -O noraui-datas-webservices-1.0.0.jar -U "Any User Agent" https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=com.github.noraui&a=noraui-datas-webservices&v=1.0.0-SNAPSHOT&p=jar
