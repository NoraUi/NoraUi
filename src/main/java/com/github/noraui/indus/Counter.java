...
public class Counter {
	...
	public static void main(String[] args) throws TechnicalException {
		if (args.length == 1) {
			...
			final List<MavenRunCounter.Counter> counters = mavenRunCounter.count(versionControlSystemsBlacklist,
					scenarioBlacklist, manager, new File(Context.getResourcesPath() + "/steps"));
