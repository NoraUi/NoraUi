...
public class Messages {
	 ...
	 *
	 * @param templateMessage Message to display before formatting
	 * @param args            Arguments
	 * @return a String containing the message well formatted.
	 * @throws TechnicalException if data input is wrong.
	 */
	 ...
	 *
	 * @param templateMessage Input string
	 * @param occurrence      String searched.
