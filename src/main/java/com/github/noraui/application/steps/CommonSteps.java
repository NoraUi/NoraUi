...
public class CommonSteps extends Step {
    ...
    public void saveValueInDataOutputProvider(PageElement pageElement, String targetColumn, List<GherkinStepCondition> conditions) throws TechnicalException, FailureException {
        String value = "";
        try {
