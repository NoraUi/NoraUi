...
public class WaitSteps extends Step {
    ...
    public void waitElementToBeClickable(PageElement pageElement, final Boolean not, List<GherkinStepCondition> conditions) {
    ...
    public void waitElementToBeNotSelected(PageElement pageElement, final Boolean not, List<GherkinStepCondition> conditions) {
    ...
    public void waitInvisibilityOf(PageElement pageElement, final Boolean not, int timeOutInSeconds, List<GherkinStepCondition> conditions) {
    ...
    public void waitInvisibilityOfElementWithText(PageElement pageElement, final String text, final Boolean not, List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfElementsToBe(PageElement pageElement, final Boolean not, final int number, List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfElementsToBeLessThan(PageElement pageElement, final Boolean not, final Integer number, List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfElementsToBeMoreThan(PageElement pageElement, final Boolean not, final Integer number, List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfWindowsToBe(final Boolean not, final Integer expectedNumberOfWindows, List<GherkinStepCondition> conditions) {
    ...
    public void waitStalenessOf(PageElement pageElement, final Boolean not, int time, List<GherkinStepCondition> conditions) {
    ...
    public void waitTextMatches(PageElement pageElement, final Boolean not, String regexp, List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBe(PageElement pageElement, final Boolean not, final String value, List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBePresentInElementLocated(PageElement pageElement, final Boolean not, final String text, List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBePresentInElementValue(PageElement pageElement, final Boolean not, String text, List<GherkinStepCondition> conditions) {
