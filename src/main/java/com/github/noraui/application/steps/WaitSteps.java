...
public class WaitSteps extends Step {
    ...
    public void waitAttributeToBe(final String attribute, PageElement pageElement, final Boolean not,
            final String value, List<GherkinStepCondition> conditions) {
    ...
    public void waitElementToBeClickable(PageElement pageElement, final Boolean not,
    ...
    public void waitInvisibilityOf(PageElement pageElement, final Boolean not, List<GherkinStepCondition> conditions) {
    ...
    public void waitInvisibilityOf(PageElement pageElement, final Boolean not, int timeOutInSeconds,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitInvisibilityOfElementWithText(PageElement pageElement, final String text, final Boolean not,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitInvisibilityOfElementWithTextWithTimeout(PageElement pageElement, final String text,
            final Boolean not, int timeOutInSeconds, List<GherkinStepCondition> conditions) {
        Wait.until(ExpectedConditions.invisibilityOfElementWithText(Utilities.getLocator(pageElement), text),
                timeOutInSeconds, not);
    }
    ...
    public void waitNumberOfElementsToBe(PageElement pageElement, final Boolean not, final int number,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfElementsToBeLessThan(PageElement pageElement, final Boolean not, final Integer number,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfElementsToBeMoreThan(PageElement pageElement, final Boolean not, final Integer number,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitNumberOfWindowsToBe(final Boolean not, final Integer expectedNumberOfWindows,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitPresenceOfElementLocated(PageElement pageElement, final Boolean not,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitPresenceOfNestedElementLocatedBy(PageElement pageElement, PageElement childPageElement,
            final Boolean not, List<GherkinStepCondition> conditions) {
        Wait.until(ExpectedConditions.presenceOfNestedElementLocatedBy(Utilities.getLocator(pageElement),
                Utilities.getLocator(childPageElement)), not);
    }
    ...
    public void waitStalenessOf(PageElement pageElement, final Boolean not, int time,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitTextMatches(PageElement pageElement, final Boolean not, String regexp,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBe(PageElement pageElement, final Boolean not, final String value,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBePresentInElementLocated(PageElement pageElement, final Boolean not, final String text,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitTextToBePresentInElementValue(PageElement pageElement, final Boolean not, String text,
            List<GherkinStepCondition> conditions) {
    ...
    public void waitTitleContains(final Boolean not, final String title, List<GherkinStepCondition> conditions) {
    ...
    public void waitTitleIs(final Boolean not, final String title, List<GherkinStepCondition> conditions) {
    ...
    public void waitUrlContains(final Boolean not, final String fraction, List<GherkinStepCondition> conditions) {
    ...
    public void waitUrlMatches(final Boolean not, final String regex, List<GherkinStepCondition> conditions) {
    ...
    public void waitUrlToBe(final Boolean not, final String url, List<GherkinStepCondition> conditions) {
    ...
    public void waitVisibilityOf(final PageElement pageElement, final Boolean not,
    ...
    public void waitVisibilityOfNestedElementsLocatedBy(final PageElement pageElement, final Boolean not,
            final PageElement childPageElement, List<GherkinStepCondition> conditions) {
