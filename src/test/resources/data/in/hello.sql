...
UNION
(select t.author as "author", t.zip as "zip", t.city as "city", t.element as "element", t.element2 as "element2", t.date as "date", t.title as "", '29' as Résultat from hello t where t.element = 'noExistElement')
UNION
...
UNION
(select t.author as "author", t.zip as "zip", t.city as "city", t.element as "element", t.element2 as "element2", t.date as "date", t.title as "", '44' as Résultat from hello t where t.zip = '')
ORDER BY "author"