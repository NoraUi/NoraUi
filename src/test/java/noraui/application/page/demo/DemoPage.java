...
public class DemoPage extends Page {
    ...
    public final PageElement bigTitle = new PageElement("-big-title", "This is a demo for NORAUI (Non-Regression Automation for User Interfaces).");
    public final PageElement inputText = new PageElement("-input-text-field", "Input Text field");
    public final PageElement inputSelect = new PageElement("-input-select-field", "Input Select field");
