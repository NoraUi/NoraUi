...
public class DemoSteps extends Step {
    ...
    public void selectCheckbox(String pageElement, String valueKey, Map<String, Boolean> values)
            throws TechnicalException, FailureException, IllegalArgumentException, IllegalAccessException {
